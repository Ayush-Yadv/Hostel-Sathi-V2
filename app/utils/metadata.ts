...
export const generateBlogMetadata = (title: string, description: string, slug: string): Metadata => ({
  ...defaultMetadata,
  title: `${title} | Hostel Sathi Greater Noida Blog`,
  description,
  alternates: {
    canonical: `https://hostelsathi.com/blogs/${slug}`,
  },
  openGraph: {
    ...defaultMetadata.openGraph,
    title: `${title} | Hostel Sathi Greater Noida Blog`,
